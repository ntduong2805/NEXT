...
const ReservationProcess = () => {
  ...
  console.log(total);
  const { data, isLoading, mutateAsync } = useCreateReservation();
  ...
  return (
    <>
      ...
      {isLoading && (
        // Use Ant Design's Spin component
        <div className="fixed top-0 left-0 w-screen h-screen flex items-center justify-center">
          <Spin size="large" />
        </div>
      )}
      <div className={`max-w-screen-xl mx-auto pb-20 pt-28 ${isLoading ? "opacity-50" : ""}`}>
            ...
            <div className="p-4 text-xs">
              <div className="text-12 line-clamp-14">
                ...
                <span className="text-blue-600 underline font-semibold">
                  House Rules, Safety Disclosures, Cancellation Policy, Next’s
              ...
              <div className="flex items-start pb-6 border-b border-gray-300">
                ...
                <div className="ml-4 flex-grow text-xs">
                  ...
                  <div className="flex items-center text-red-500">
                    ...
                    <span className="ml-2 font-medium">{reservation?.avgRating}</span>
                    <span className="ml-2">・</span>
                    <span>({reservation?.totalReview} reviews)</span>
                  </div>
                </div>
              </div>
